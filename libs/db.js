...
const principalswrapper={
    ...
    findandcountall:(options)=>principals.findAndCountAll(options),
...
const userswrapper={
    ...
    findandcountall:(options)=>users.findAndCountAll(options),
...
const calendarswrapper={
    ...
    findandcountall:(options)=>calendars.findAndCountAll(options),
...
const calendarobjectswrapper={
    ...
    findandcountall:(options)=>calendarobjects.findAndCountAll(options),
...
const calendarchangeswrapper={
    ...
    findandcountall:(options)=>calendarchanges.findAndCountAll(options),
...
const addressbookswrapper={
    ...
    findandcountall:(options)=>addressbooks.findAndCountAll(options),
...
const vcardswrapper={
    ...
    findandcountall:(options)=>vcards.findAndCountAll(options),
...
const addressbookchangeswrapper={
    ...
    findandcountall:(options)=>addressbookchanges.findAndCountAll(options),
...
const lockswrapper={
    ...
    findandcountall:(options)=>locks.findAndCountAll(options),
...
const propertystoragewrapper={
    ...
    findandcountall:(options)=>propertystorage.findAndCountAll(options),
